(() => {
  ...
  window.addEventListener("load", function (e) {
    pe(),
      document.querySelector(".body-kind__slider") &&
        new ae(".body-kind__slider", {
          modules: [le, ce],
          observer: !0,
          observeParents: !0,
          slidesPerView: 4,
          ...
          autoHeight: !0,
          speed: 800,
          pagination: { el: ".body-kind__dotts", clickable: !0 },
          navigation: {
  ...
  new he("max").init();
  const fe = document.querySelectorAll("._anim-items");
  if (fe.length > 0) {
    function e() {
